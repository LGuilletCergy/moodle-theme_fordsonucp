 ...
 *
 * File : settings/customlogin_settings.php
...
// Icon Navigation);
$page = new admin_settingpage('theme_fordsonucp_customlogin', get_string('customloginheading', 'theme_fordson'));

// This is the descriptor for icon One.
$name = 'theme_fordsonucp/customlogininfo';
...
$name = 'theme_fordsonucp/showcustomlogin';
...
// Top image.
$name = 'theme_fordsonucp/logintopimage';
...
// Login form color.
$name = 'theme_fordsonucp/fploginform';
...
// This is the descriptor for icon One
$name = 'theme_fordsonucp/loginnavicon1info';
...
// icon One
$name = 'theme_fordsonucp/loginnav1icon';
...
$name = 'theme_fordsonucp/loginnav1titletext';
...
$name = 'theme_fordsonucp/loginnav1icontext';
...
// This is the descriptor for icon One
$name = 'theme_fordsonucp/loginnavicon2info';
$heading = get_string('loginnavicon2', 'theme_fordson');
$information = get_string('navicondesc', 'theme_fordson');
$setting = new admin_setting_heading($name, $heading, $information);
$page->add($setting);

$name = 'theme_fordsonucp/loginnav2icon';
$title = get_string('navicon', 'theme_fordson');
$description = get_string('navicondesc', 'theme_fordson');
$default = '';
$setting = new admin_setting_configtext($name, $title, $description, $default);
...
$name = 'theme_fordsonucp/loginnav2titletext';
$title = get_string('loginnavicontitletext', 'theme_fordson');
$description = get_string('loginnavicontitletextdesc', 'theme_fordson');
$default = '';
$setting = new admin_setting_configtext($name, $title, $description, $default);
...
$name = 'theme_fordsonucp/loginnav2icontext';
$title = get_string('loginnavicontext', 'theme_fordson');
$description = get_string('loginnavicontextdesc', 'theme_fordson');
$default = '';
$setting = new admin_setting_confightmleditor($name, $title, $description, $default);
...
$name = 'theme_fordsonucp/loginnavicon3info';
$heading = get_string('loginnavicon3', 'theme_fordson');
$information = get_string('navicondesc', 'theme_fordson');
$setting = new admin_setting_heading($name, $heading, $information);
$page->add($setting);

$name = 'theme_fordsonucp/loginnav3icon';
$title = get_string('navicon', 'theme_fordson');
$description = get_string('navicondesc', 'theme_fordson');
$default = '';
$setting = new admin_setting_configtext($name, $title, $description, $default);
...
$name = 'theme_fordsonucp/loginnav3titletext';
$title = get_string('loginnavicontitletext', 'theme_fordson');
$description = get_string('loginnavicontitletextdesc', 'theme_fordson');
$default = '';
$setting = new admin_setting_configtext($name, $title, $description, $default);
...
$name = 'theme_fordsonucp/loginnav3icontext';
$title = get_string('loginnavicontext', 'theme_fordson');
$description = get_string('loginnavicontextdesc', 'theme_fordson');
$default = '';
$setting = new admin_setting_confightmleditor($name, $title, $description, $default);
...
$name = 'theme_fordsonucp/loginnavicon4info';
$heading = get_string('loginnavicon4', 'theme_fordson');
$information = get_string('navicondesc', 'theme_fordson');
$setting = new admin_setting_heading($name, $heading, $information);
$page->add($setting);

$name = 'theme_fordsonucp/loginnav4icon';
$title = get_string('navicon', 'theme_fordson');
$description = get_string('navicondesc', 'theme_fordson');
$default = '';
$setting = new admin_setting_configtext($name, $title, $description, $default);
...
$name = 'theme_fordsonucp/loginnav4titletext';
$title = get_string('loginnavicontitletext', 'theme_fordson');
$description = get_string('loginnavicontitletextdesc', 'theme_fordson');
$default = '';
$setting = new admin_setting_configtext($name, $title, $description, $default);
...
$name = 'theme_fordsonucp/loginnav4icontext';
$title = get_string('loginnavicontext', 'theme_fordson');
$description = get_string('loginnavicontextdesc', 'theme_fordson');
$default = '';
$setting = new admin_setting_confightmleditor($name, $title, $description, $default);
...
$page->add($setting);
// Feature image.
$name = 'theme_fordsonucp/feature1image';
...
// This is the descriptor for a feature.
$name = 'theme_fordsonucp/feature2info';
$heading = get_string('feature2info', 'theme_fordson');
$information = get_string('featureinfo_desc', 'theme_fordson');
$setting = new admin_setting_heading($name, $heading, $information);
$page->add($setting);
// Feature text.
$name = 'theme_fordsonucp/feature2text';
$title = get_string('featuretext', 'theme_fordson');
$description = get_string('featuretext_desc', 'theme_fordson');
$default = '';
$setting = new admin_setting_confightmleditor($name, $title, $description, $default);
...
$page->add($setting);
// Feature image.
$name = 'theme_fordsonucp/feature2image';
$title = get_string('featureimage', 'theme_fordson');
$description = get_string('featureimage_desc', 'theme_fordson');
...
// This is the descriptor for a feature.
$name = 'theme_fordsonucp/feature3info';
$heading = get_string('feature3info', 'theme_fordson');
$information = get_string('featureinfo_desc', 'theme_fordson');
$setting = new admin_setting_heading($name, $heading, $information);
$page->add($setting);
// Feature text.
$name = 'theme_fordsonucp/feature3text';
$title = get_string('featuretext', 'theme_fordson');
$description = get_string('featuretext_desc', 'theme_fordson');
$default = '';
$setting = new admin_setting_confightmleditor($name, $title, $description, $default);
...
$page->add($setting);
// Feature image.
$name = 'theme_fordsonucp/feature3image';
$title = get_string('featureimage', 'theme_fordson');
$description = get_string('featureimage_desc', 'theme_fordson');
