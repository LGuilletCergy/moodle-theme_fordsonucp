...
$page->add(new admin_setting_heading('theme_fordsonucp_colours', get_string('colours_headingsub', 'theme_fordson'), format_text(get_string('colours_desc' , 'theme_fordson'), FORMAT_MARKDOWN)));

    // Raw SCSS to include before the content.
    $setting = new admin_setting_configtextarea('theme_fordsonucp/scsspre',
    get_string('rawscsspre', 'theme_fordson'), get_string('rawscsspre_desc', 'theme_fordson'), '', PARAM_RAW);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    // Variable $brandprimary.
    $name = 'theme_fordsonucp/brandprimary';
    ...
    $name = 'theme_fordsonucp/brandsuccess';
    ...
    $name = 'theme_fordsonucp/brandwarning';
    ...
    $name = 'theme_fordsonucp/branddanger';
    ...
    // Variable $brandinfo.
    $name = 'theme_fordsonucp/brandinfo';
    ...
    $name = 'theme_fordsonucp/bodybackground';
    ...
    $name = 'theme_fordsonucp/breadcrumbbkg';
    ...
    // Drawer background
    $name = 'theme_fordsonucp/drawerbkg';
    ...
    $name = 'theme_fordsonucp/footerbkg';
    ...
    $name = 'theme_fordsonucp/markettextbg';
    ...
    $setting = new admin_setting_configtextarea('theme_fordsonucp/scss', get_string('rawscss', 'theme_fordson'),
